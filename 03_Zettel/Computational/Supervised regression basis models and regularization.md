...
$$E(\mathbf{w}) = \frac{1}{2} \| \mathbf{y} - \boldsymbol{\Phi} \mathbf{w} \|^2$$
...
1. **Ridge Regression ($L_2$ regularization / Tikhonov)**:
   ...
   $$E_{\text{Ridge}}(\mathbf{w}) = \frac{1}{2} \| \mathbf{y} - \boldsymbol{\Phi} \mathbf{w} \|^2 + \frac{\lambda}{2} \| \mathbf{w} \|_2^2$$
...
2. **Lasso Regression ($L_1$ regularization)**:
   $$E_{\text{Lasso}}(\mathbf{w}) = \frac{1}{2} \| \mathbf{y} - \boldsymbol{\Phi} \mathbf{w} \|^2 + \lambda \sum_{j=1}^{M-1} |w_j|$$

...
![xray_detector_p1_img1.png](../../assets/images/xray_detector_p1_img1.png)
*X-ray CCD architecture: silicon band gap ($w = 3.68$ eV), photoelectric photon absorption creating electron cloud $N_e = E_{\rm ph}/w$, and charge packet collection.*


![xray_detector_p2_img1.png](../../assets/images/xray_detector_p2_img1.png)
*Split-event grades: single-pixel events (Grade 0), two-pixel horizontal/vertical splits, and 3-4 pixel split clusters.*


![xray_detector_p2_img2.png](../../assets/images/xray_detector_p2_img2.png)
*Photon pile-up: arrival of two or more X-ray photons in the same pixel or adjacent pixels during a single readout frame, causing spectral hardening and flux loss.*

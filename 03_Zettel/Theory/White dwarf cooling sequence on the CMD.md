...
- the WDCS thus has a characteristic **hook** at faint magnitudes (see [[WDCS turn to blue and CIA]]).
...
this case study is a beautiful illustration of how unresolved binaries can corrupt CMD analyses — a recurring theme across stellar astrophysics ([[Binary stars in CMD]]).

...
- [[Distributions]] — Poisson, Gaussian, binomial; moments
- [[Signal-Noise Ratio]] — detection, exposure time scaling
- [[Fitting]] — $\chi^2$, C-statistics, forward folding, RMF/ARF
- [[p-value]] — hypothesis testing, significance, null hypothesis

---

### High-Energy Laboratory Diagnostics & Instrument Panels

![j0529_quasar_p1_page.png](../../assets/images/j0529_quasar_p1_page.png)
*High-energy discovery of Quasar J0529-4351: the most luminous known quasar in the universe ($L_{\rm bol} \sim 10^{48}$ erg/s), hosting a $1.7 \times 10^{10} M_\odot$ supermassive black hole accreting $\sim 1 M_\odot$/day.*


![j0529_quasar_p2_page.png](../../assets/images/j0529_quasar_p2_page.png)
*VLT X-shooter UV/optical spectrum and Swift XRT X-ray observations of J0529-4351, constraining disk emission and X-ray corona luminosity.*


![j0529_quasar_p3_page.png](../../assets/images/j0529_quasar_p3_page.png)
*Spectral Energy Distribution (SED) decomposition: standard Shakura-Sunyaev thin accretion disk + hot corona X-ray powerlaw.*

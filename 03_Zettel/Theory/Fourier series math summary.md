...
this is the [Discrete Fourier transform](./Discrete%20Fourier%20transform.html). the DFT inherits all the structure (linearity, Parseval, convolution) from its continuous parent.

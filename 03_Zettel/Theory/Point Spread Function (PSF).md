...
![swift_m87_p1_page.png](../../assets/images/swift_m87_p1_page.png)
*Swift XRT observation of M87: count image in the 0.3-10 keV band showing active galactic nucleus point source and diffuse Virgo cluster thermal emission.*


![swift_m87_p2_img1.jpeg](../../assets/images/swift_m87_p2_img1.jpeg)
*Source extraction region (circular radius $r_{\rm src} = 30$ pixels) and background annulus ($r_{\rm in}=50, r_{\rm out}=80$ pixels) centered on M87 core.*


![swift_m87_p2_img2.jpeg](../../assets/images/swift_m87_p2_img2.jpeg)
*Swift XRT radial Point Spread Function (PSF) King profile: $PSF(r) = \left[1 + (r/r_c)^2\right]^{-\beta}$ fitted to calibrate source aperture correction.*

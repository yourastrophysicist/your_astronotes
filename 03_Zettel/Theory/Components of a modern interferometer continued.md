...
precise binary-star astrometry → orbital parameters → dynamical masses. precision $\sim 1\%$ for many systems (see [Binary star orbits](interf/Binary%20star%20orbits.html)).

...
the sky background ([[Sky brightness]]) contributes photons to every pixel:
...
dividing the source signal by this gives the SNR formula (see [[The CCD equation]]).
...
- **CTE losses** (see [[CCD readout chain]]).
...
the regime determines whether to take long single exposures or short stacked ones. see [[The CCD equation]] for the full discussion.
...
![obs_ccd-17.png](../../assets/images/obs_ccd-17.png)
*Classification of noise sources: Poisson shot noise vs Gaussian detector noise.*

![obs_ccd-18.png](../../assets/images/obs_ccd-18.png)
*Source photon shot noise: sigma_* = sqrt(N_*) electrons.*

![obs_ccd-19.png](../../assets/images/obs_ccd-19.png)
*Sky background shot noise: sigma_sky = sqrt(n_pix * N_sky) electrons.*

![obs_ccd-20.png](../../assets/images/obs_ccd-20.png)
*Thermal dark current generation: cooling CCDs with liquid nitrogen or Peltier coolers (-100 C).*

![obs_ccd-21.png](../../assets/images/obs_ccd-21.png)
*Dark current shot noise: sigma_d = sqrt(n_pix * N_d) electrons.*

![obs_ccd-22.png](../../assets/images/obs_ccd-22.png)
*Readout noise sigma_RN: reset noise, FET Johnson noise, 1/f noise (typically 2-5 e- RMS).*

![obs_ccd-23.png](../../assets/images/obs_ccd-23.png)
*Correlated Double Sampling (CDS) to eliminate output node reset noise.*

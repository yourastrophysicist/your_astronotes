...
![obs_atm-33.png](../../../assets/images/obs_atm-33.png)
*Scintillation: intensity fluctuations caused by high-altitude refractive index variations.*

![obs_atm-34.png](../../../assets/images/obs_atm-34.png)
*Young scintillation index formula: sigma_I / I proportional to D^(-2/3) X^(1.75) t^(-1/2).*

![obs_atm-35.png](../../../assets/images/obs_atm-35.png)
*Aperture-averaging effect: why large telescopes suffer far less scintillation than small apertures.*

...
typical range: 2500 K (late M dwarfs) to 50{,}000+ K (O stars). it sets the shape of the continuum and the populations of atomic levels (via Boltzmann), hence the relative line strengths. see [[Spectroscopic determination of Teff]].
...
- $\log g \approx 7\text{-}9$ for white dwarfs (see [[White dwarf overview]]).
$\log g$ controls the photospheric pressure (because hydrostatic equilibrium gives $P \propto g$), and therefore pressure broadening (Stark, van der Waals) and the ionisation balance through the [[Saha ionisation equation]]. see [[Spectroscopic determination of log g]].
...
a fifth quantity, the projected rotation $v\sin i$, is often added to the parameter set because it broadens all lines uniformly (see [[Stellar rotation v sini]]).

...
- [[Distance modulus]]
- [[Interstellar absorption]] — the analogous problem for ISM dust

---

## observational astrophysics course slides (Prof. Paolo Cassata)

![obs_atm-25.png](../../../assets/images/obs_atm-25.png)
*Beer-Lambert absorption law: I(lambda) = I_0(lambda) exp(-tau(lambda)).*

![obs_atm-26.png](../../../assets/images/obs_atm-26.png)
*Optical depth tau(lambda) = k(lambda) * X, where X is airmass.*

![obs_atm-27.png](../../../assets/images/obs_atm-27.png)
*Plane-parallel atmosphere approximation: airmass X = sec z.*

![obs_atm-28.png](../../../assets/images/obs_atm-28.png)
*Bemporad airmass formula for large zenith angles z > 60 deg.*

![obs_atm-29.png](../../../assets/images/obs_atm-29.png)
*Observed magnitude: m_obs(lambda) = m_0(lambda) + k(lambda) * X.*

![obs_atm-30.png](../../../assets/images/obs_atm-30.png)
*Bouguer line method: measuring standard stars at varying airmass to determine k(lambda) and m_0.*

![obs_atm-31.png](../../../assets/images/obs_atm-31.png)
*Extinction coefficients across UBVRI passbands (k_U > k_B > k_V > k_R > k_I).*

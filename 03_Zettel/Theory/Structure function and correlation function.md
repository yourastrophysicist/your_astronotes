...
![Phase structure function $D_\phi(r) \propto (r/r_0)^{5/3}$ quantifying phase variance across spatial separation $r$.](Interferometry/Structure_function_and_correlation_function.png)

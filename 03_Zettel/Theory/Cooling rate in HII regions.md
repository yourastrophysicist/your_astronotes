...
so **$T_e$ is anti-correlated with metallicity**, the opposite of intuition. used as a metallicity diagnostic via direct $T_e$ measurements ([[OIII forbidden lines]]).
...
at $T_e \sim 10^4$ K, free-free emission is **subdominant** to forbidden lines. but at $T \gtrsim 10^7$ K (cluster ICM, SNR shocks), free-free becomes the dominant cooling mechanism. see [[Bremsstrahlung]].

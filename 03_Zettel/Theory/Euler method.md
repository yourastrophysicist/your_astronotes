...
![mnm_solution_p1_euler_rk.png](../../assets/images/mnm_solution_p1_euler_rk.png)
*Exam Model Solution: Comparison of Forward Euler (first-order global error $\mathcal{O}(\Delta t)$, unconditional instability for harmonic oscillators) vs RK4.*


![mnm_exam_2021_01_25_p1.png](../../assets/images/mnm_exam_2021_01_25_p1.png)

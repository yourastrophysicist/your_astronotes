...
so the syllabus is a dependency graph. the order in [Mathematical_Numerical_Methods_MOC](../../04_Atlas/Mathematical_Numerical_Methods_MOC.html) follows this graph from the leaves up.

...
*Lecture 4: Charge-Coupled Devices (CCD) and Signal-to-Noise Ratio (SNR).*

![obs_ccd-02.png](../../assets/images/obs_ccd-02.png)
*Historical perspective: photographic plates vs photomultipliers vs CCDs.*

![obs_ccd-03.png](../../assets/images/obs_ccd-03.png)
*Advantages of CCDs: high quantum efficiency, wide dynamic range, linearity, digital output.*

![obs_ccd-04.png](../../assets/images/obs_ccd-04.png)
*Silicon semiconductor physics: bandgap energy E_g = 1.12 eV, cut-off wavelength ~ 1.1 um.*

![obs_ccd-05.png](../../assets/images/obs_ccd-05.png)
*Metal-Oxide-Semiconductor (MOS) capacitor structure and potential wells.*

![obs_ccd-06.png](../../assets/images/obs_ccd-06.png)
*Charge accumulation and full well capacity (typically 50,000 to 100,000 electrons).*

![obs_ccd-07.png](../../assets/images/obs_ccd-07.png)
*Front-illuminated vs back-illuminated / thinned CCDs (QE > 90% in optical).*

![obs_ccd-08.png](../../assets/images/obs_ccd-08.png)
*Deep-depletion CCDs for enhanced red and NIR quantum efficiency.*

![obs_ccd-31.png](../../assets/images/obs_ccd-31.png)
*Synthetic aperture photometry principles: source aperture and sky background annulus.*

![obs_ccd-32.png](../../assets/images/obs_ccd-32.png)
*Aperture growth curves and selecting optimal aperture radius to maximize SNR.*

![obs_ccd-33.png](../../assets/images/obs_ccd-33.png)
*PSF fitting photometry for crowded fields (globular clusters, galactic bulges).*

![obs_ccd-34.png](../../assets/images/obs_ccd-34.png)
*DAOPHOT software algorithms: FIND, PHOT, ALLSTAR PSF modeling.*

![obs_ccd-35.png](../../assets/images/obs_ccd-35.png)
*Standard calibration pipeline: Bias subtraction, Dark subtraction, Flat-fielding.*

...
see [[OIII forbidden lines]] for full discussion.
...
$T_e$ is **anti-correlated with metallicity** (since metal-line cooling is the dominant cooling mechanism, see [[Equilibrium temperature]]):

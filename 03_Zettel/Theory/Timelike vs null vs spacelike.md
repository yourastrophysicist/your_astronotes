...
a **timelike** geodesic's tangent stays timelike (length-preserving parallel transport, see [[Metric compatibility]]). similarly null and spacelike. the type is preserved.

...
useful for horizon arguments (see [[Standard model problems]] and [[Inflation overview]]).
...
- [[Baumann_reference]] — chapter 1.1 has the full derivation with all the box-by-box detail

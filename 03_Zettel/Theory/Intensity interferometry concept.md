...
![Intensity interferometry setup correlating detector current fluctuations $\langle I_1 I_2\rangle$ from two separate light collectors.](Interferometry/Intensity_interferometry_concept.svg)
...
![Sensitivity_and_modern_revival.jpeg](../../assets/images/Sensitivity_and_modern_revival.jpeg)
*Sensitivity comparison and modern revival of stellar intensity interferometry using fast single-photon avalanche photodiodes (SPADs) and Cherenkov telescope arrays (CTA).*


![ivkovic_2024_fig1.png](../../assets/images/ivkovic_2024_fig1.png)
*Ivkovic et al. (2024) Figure 1: Second-order intensity correlation $g^{(2)}(\tau)$ measurement setup and photon arrival time statistics.*


![ivkovic_2024_fig3.png](../../assets/images/ivkovic_2024_fig3.png)
*Ivkovic et al. (2024) Figure 3: Optical telescope array geometry and baseline distribution for stellar angular diameter measurements.*
...
*Ivkovic et al. (2024) Figure 5: Signal-to-noise ratio scaling of intensity interferometers vs photon flux and detector time resolution $\Delta t$.*

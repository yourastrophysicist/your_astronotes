...
- 1.2 Kinematics: geodesics, redshift, distances — supplements 03_Zettel/Theory/Cosmological distances and [[Hubble law derivation low-z]].
- 1.3 Dynamics: matter sources, spacetime curvature, **Friedmann equations** — parallel to [[Newtonian Friedmann derivation]] and Friedmann equations with Λ but with the full GR treatment.
...
the textbook source for [[Inflation overview]], [[Inflaton scalar field dynamics]], [[Old vs new vs chaotic inflation, slow-roll]].
...
this is the rigorous companion to [[BBN_overview]], [[Saha equation and recombination]], Dark matter relics — WIMP miracle, and [[Boltzmann equation in cosmology]].

### Part II — The Inhomogeneous Universe

**chapter 4 — Cosmological Perturbation Theory**
- 4.1 Newtonian: perturbed fluid eqs, Jeans' instability, dark matter inside Hubble — supplements [[Linear evolution of perturbations in expanding universe]] and [[Jeans analysis in expanding universe]]
...
parallel to [[Growth factor D(z)]] and the structure-formation block.

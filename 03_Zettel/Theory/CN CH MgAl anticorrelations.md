...
---
the [[Na O anticorrelation]] is the most famous, but it is one of a family of element-pair anti-correlations seen in globular cluster stars. each pair traces a different proton-capture chain operating at a characteristic temperature in the polluter. together they paint a full picture of hot H burning + let us rank GCs by how extreme their pollution was.
...
UV photometry from HST F275W + F336W is essentially a high-contrast CN+NH thermometer + this is what powers [[Photometric chromosome maps]].

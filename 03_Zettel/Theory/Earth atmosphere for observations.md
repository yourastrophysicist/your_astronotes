...
![obs_atm-01.png](../../assets/images/obs_atm-01.png)
*Lecture 2: The Earth Atmosphere as the last optical element.*

![obs_atm-02.png](../../assets/images/obs_atm-02.png)
*The atmosphere problem: absorption, extinction, scintillation, seeing.*

![obs_atm-03.png](../../assets/images/obs_atm-03.png)
*Vertical structure of temperature and pressure in the atmosphere.*

![obs_atm-04.png](../../assets/images/obs_atm-04.png)
*Barometric formula: P(h) = P_0 exp(-h/H) with scale height H ~ 8 km.*

![obs_atm-05.png](../../assets/images/obs_atm-05.png)
*Chemical composition of dry air and trace absorbers (H2O, CO2, O3, CH4).*

![obs_atm-06.png](../../assets/images/obs_atm-06.png)
*Vertical water vapor profile concentrated in the lower troposphere.*

![obs_atm-07.png](../../assets/images/obs_atm-07.png)
*Precipitable water vapor (PWV) at high astronomical sites.*

![obs_atm-08.png](../../assets/images/obs_atm-08.png)
*Ozone layer in the stratosphere absorbing UV radiation below 3000 A.*

![obs_atm-09.png](../../assets/images/obs_atm-09.png)
*Atmospheric thermal emission in the infrared (3 to 30 microns).*

![obs_atm-10.png](../../assets/images/obs_atm-10.png)
*Comparison of ground-based vs space-based observing conditions.*

![obs_atm-45.png](../../assets/images/obs_atm-45.png)
*Asiago Astrophysical Observatory climate chart and seasonal seeing.*

![obs_atm-46.png](../../assets/images/obs_atm-46.png)
*Observing site criteria: photometric nights, seeing, PWV, wind.*

![obs_atm-47.png](../../assets/images/obs_atm-47.png)
*Paranal (VLT) and Mauna Kea site quality statistics.*

...
so dark matter perturbations grow strongly only after matter-radiation equality at $z_{\rm eq} \sim 3300$. the Meszaros effect is what determines the position of the **turnover** in the matter power spectrum (see [[Matter power spectrum and BAO]]).
...
→ see [[Growth factor D(z)]] for the full analytic form.

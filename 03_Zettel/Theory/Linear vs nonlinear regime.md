...
linear theory predicts evolution by ODEs (see [[Perturbations in an expanding universe]]). evolution is solvable analytically.
...
see [[Press-Schechter halo mass function]].

...
the matter power spectrum (see [[Matter power spectrum and BAO]]) has a turnover at the equality scale, but **CDM continues to have power below the turnover**. HDM would have an exponential cutoff in $P_m(k)$ at the free-streaming scale.

...
---
reading the [[Color-magnitude diagrams of clusters]] of an old, populous cluster means recognising six evolutionary loci that each correspond to a specific interior burning configuration. the same six loci appear, suitably shifted, in the [[HR diagram]] $(\log L, \log T_\mathrm{eff})$.

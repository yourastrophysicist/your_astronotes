---
layout: "default"
title: "Stellar evolutionary phases on the CMD"
---
reading the [Color-magnitude diagrams of clusters](Color-magnitude%20diagrams%20of%20clusters.html) of an old, populous cluster means recognising six evolutionary loci that each correspond to a specific interior burning configuration. the same six loci appear, suitably shifted, in the [HR diagram](HR%20diagram.html) $(\log L, \log T_\mathrm{eff})$.

...
![obs_rad-069.png](../../assets/images/obs_rad-069.png)
*Obs6 exam question: Why photometric systems cannot be converted by a constant offset.*

![obs_rad-070.png](../../assets/images/obs_rad-070.png)
*Color term definition: m_A - m_B = a + b * (c1 - c2).*

![obs_rad-071.png](../../assets/images/obs_rad-071.png)
*Example: SDSS-i vs Cousins-I transformation depending on star temperature / SED shape.*

...
up: [[Pablo_02_Statistical_properties_of_galaxies]] · [[Photometric redshifts]]
...
- previous: [[Photometric redshifts]]
- driving statistics: [[Redshift distribution of flux-limited samples]], [[Malmquist bias]]
- LF estimation under photo-z uncertainty: [[1Vmax estimator]] needs $V_{\max}$ to be marginalized over $p(z)$

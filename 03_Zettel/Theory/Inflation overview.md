...
inflation is designed to solve the **fine-tuning problems** of the standard hot Big Bang model: flatness, horizon, monopoles (see [[Standard model problems]]).
...
→ see [[Inflaton scalar field dynamics]] and [[Old vs new vs chaotic inflation, slow-roll]] for the technical details.
...
→ see [[Brief thermal history]] for the full timeline.
...
- [[Baryogenesis]]
- [[Baumann_reference]] — chapter 2 is the rigorous treatment

...
[[Photometric chromosome maps]] rely on UV photometry where dust extinction is strongest. the chromosome-map axes:
...
in these fields, even a tight CMD ridge has DR-induced scatter $\sigma \sim 0.05$-$0.15$ mag. without DR mapping (see [[Differential reddening maps]]), no chromosome map is publishable.

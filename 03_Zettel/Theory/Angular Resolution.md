...
The blur circle radius $\sigma_{blur}$ of the [[Point Spread Function (PSF)]] has contributions:
...
1. Allows detection of faint sources with low background contamination
	...
	- SNR for a point source: $SNR \propto A_{eff}/HPD$ in the background-dominated regime — see [[Signal-Noise Ratio]]

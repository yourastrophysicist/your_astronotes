...
---
**density parameters** $\Omega_X$ are dimensionless ratios of cosmic energy densities to the **critical density**. they parameterise $\Lambda$CDM + are the natural variables in the Friedmann equation. companion: [[Density parameters and flatness]].

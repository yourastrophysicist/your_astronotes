...
calibrators: Galactic Cepheids with Gaia parallaxes; SMC and LMC Cepheids with eclipsing-binary geometric distances. see [[Cepheid period-luminosity relation]].
...
![obs_dist-19.png](../../assets/images/obs_dist-19.png)
*RR Lyrae variable stars: horizontal branch stars with P < 1 day, constant M_V ~ +0.6 mag.*

![obs_dist-20.png](../../assets/images/obs_dist-20.png)
*RR Lyrae as distance indicators for globular clusters and Galactic halo.*

![obs_dist-21.png](../../assets/images/obs_dist-21.png)
*Mira long-period variables (LPVs) on the Asymptotic Giant Branch.*

![obs_dist-22.png](../../assets/images/obs_dist-22.png)
*Eclipsing binary stars: geometric distance determination via radial velocity and light curves.*

![obs_dist-23.png](../../assets/images/obs_dist-23.png)
*Detached eclipsing binaries as distance anchors to the LMC and M31.*

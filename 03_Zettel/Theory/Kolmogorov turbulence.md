...
![Kolmogorov atmospheric turbulence model showing phase distortion cascade from outer scale $L_0$ to dissipation scales $l_0$.](../../assets/images/Kolmogorov_turbulence.png)

...
(see [[Number density and energy density at thermal equilibrium]]), the Friedmann equation is:
...
a famous BBN application: extra light degrees of freedom (a fourth neutrino species, primordial gravitational waves) would increase $g_*$ at $T \sim 1$ MeV, increase $H$, force earlier n/p freeze-out, and give a *higher* primordial $^4$He abundance. so observed $Y_p$ constrains the count of light species at the BBN epoch. → see [[BBN_predictions]].

---

## $T \propto 1/a$ as a corollary

combined with entropy conservation $g_{*s} T^3 a^3 = $ const (see [[Conservation of entropy in a comoving volume]]), this gives:

...
this is the standard way to populate the [[HR diagram]] with both luminosity and radius.
...
![obs_rad-073.png](../../assets/images/obs_rad-073.png)
*Bolometric magnitude m_bol and absolute bolometric magnitude M_bol.*

![obs_rad-074.png](../../assets/images/obs_rad-074.png)
*Bolometric correction BC definition: BC = m_bol - m_V = M_bol - M_V (IAU sign convention).*

![obs_rad-075.png](../../assets/images/obs_rad-075.png)
*Solar values: M_bol,Sun = 4.74 mag, L_Sun = 3.828 x 10^33 erg/s.*

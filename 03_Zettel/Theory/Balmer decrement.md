...
up: [[Pablo_03_Star_formation_in_galaxies]] · [[H-alpha SFR tracer]]
...
the **gas** $E(B-V)_{\text{gas}}$ measured from Balmer decrement is generally *larger* than the **stellar** $E(B-V)_{\text{star}}$ measured from continuum slope, because HII regions live deeper in birth clouds (see Charlot & Fall 2000 in [[Dust attenuation and extinction curves]]). typical ratio, from Calzetti 2000:
...
- primary use: [[H-alpha SFR tracer]]
- extinction curves: [[Dust attenuation and extinction curves]]
- alternative correction: [[UV slope and IRX-beta relation]]

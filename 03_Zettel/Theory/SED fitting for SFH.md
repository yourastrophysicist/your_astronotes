...
beyond the Local Group we cannot resolve individual stars (see [[SFH from resolved CMDs]]). the only accessible observable is the integrated SED. the goal of SED fitting is:
...
- **SFH parametrization**: delta, tau-model, delayed-tau, non-parametric (see [[Star formation history parametrizations]])
- **attenuation curve**: Calzetti, Cardelli, Charlot-Fall, or free (see [[Dust attenuation and extinction curves]])
...
- models used: [[Stellar population synthesis]]
- parametric forms: [[Star formation history parametrizations]]
- resolved alternative: [[SFH from resolved CMDs]]
- extinction: [[Dust attenuation and extinction curves]]
- FIR input: [[IR SFR tracer]]
- stellar mass: [[Stellar mass function]]

...
![obs_dist-31.png](../../assets/images/obs_dist-31.png)
*Moving cluster method: geometric distance to nearby star clusters (Hyades).*

![obs_dist-32.png](../../assets/images/obs_dist-32.png)
*Convergent point geometry: proper motion vectors intersecting at convergent point theta.*

![obs_dist-33.png](../../assets/images/obs_dist-33.png)
*Kinematic relations: v_t = v * sin theta, v_r = v * cos theta.*

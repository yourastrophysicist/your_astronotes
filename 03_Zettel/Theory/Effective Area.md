...
![xray_detector_p4_img2.png](../../assets/images/xray_detector_p4_img2.png)
*Effective area $A_{\rm eff}(E) = A_{\rm geo} \times R_1(E) R_2(E) \times T_{\rm filter}(E) \times {\rm QE}(E)$ energy curve showing Au/Ir M-edges.*

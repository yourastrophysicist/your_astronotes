...
with the photon number density $n_\gamma = (2\zeta(3)/\pi^2) T^3 \simeq 422$ cm$^{-3}$ at $T_0 = 2.725$ K (see [[Cosmic_inventory_photons]]):
...
the NSE mass fractions (see [[BBN_NSE_initial_conditions]]) scale as
$$X_A \propto \eta^{A-1}$$
...
so measuring any one of those abundances precisely fixes $\eta$ — and hence $\Omega_b h^2$. this is method 3 in [[Cosmic_inventory_baryons]].

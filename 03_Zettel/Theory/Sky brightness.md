...
for faint sources, photon noise from sky pixels dominates the noise budget (see [[CCD detectors and SNR]] and [[The CCD equation]]). the signal-to-noise ratio is then
...
- [[Ecliptic system]] — zodiacal light

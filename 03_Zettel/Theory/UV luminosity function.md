...
*Evolution of the rest-frame UV luminosity function from z = 0 to z = 8 (Madau & Dickinson 2014).*

![bouwens2015_UV_LF.png](../../assets/images/bouwens2015_UV_LF.png)
*JWST and HST UV luminosity functions at z = 4 to 10 from Bouwens et al. (2015).*

![madau2014_SED_templates.png](../../assets/images/madau2014_SED_templates.png)
*Synthetic SED templates for star-forming galaxies across cosmic epochs.*
{% endraw %}

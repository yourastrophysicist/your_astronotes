...
1. **Newtonian limit**: slow motion + weak field. $h_{00} = -2\Phi/c^2$ recovers Poisson's equation $\nabla^2\Phi = 4\pi G\rho$. see [[Newtonian limit of GR]].
2. **Gravitational waves**: vacuum solutions $\Box h_{\mu\nu} = 0$ admit travelling-wave solutions, the GWs detected by LIGO. see [[Plus and cross polarizations]] and [[Quadrupole formula]].

...
---
**cosmological inflation** is a brief period of nearly-exponential expansion in the very early universe ($t \sim 10^{-32}$ s), driving the universe through $\sim 60$ e-folds. proposed by Guth (1981) + Linde + Steinhardt + Albrecht to solve the **horizon, flatness, and monopole problems** of the Hot Big Bang. (companion: [[Inflation overview]] for additional context.)

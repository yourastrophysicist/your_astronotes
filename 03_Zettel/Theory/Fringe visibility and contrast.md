...
an interferometer measures both, in principle. in practice, atmospheric turbulence corrupts the phase, leaving only $|\mathcal V|$ measurable directly. the phase must be recovered with [phase closure](interf/Phase%20closure.html) or similar techniques.

...
best for HII regions and PNe at $T_e \sim 10^4$ K. see [[OIII forbidden lines]] for the canonical case.
...
best for typical HII regions and PNe. see [[SII forbidden lines]].
...
these enter the **BPT diagram** for AGN classification. see [[BPT diagram]].
...
2. **dust correction**: from $H\alpha/H\beta$ via [[Balmer decrement]].

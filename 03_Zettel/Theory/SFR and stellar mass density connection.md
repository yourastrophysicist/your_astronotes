...
1. **direct SFR**: measure UV continuum, IR luminosity, or H$\alpha$ → SFR per galaxy → integrate over LF → $\rho_{SFR}(z)$. this is what Pérez-González 2005 ([[Cosmic star formation history]]) does.
2. **integrated stellar mass**: measure SED-fit stellar masses → integrate SMF → $\rho_*(z)$. this is what Pérez-González 2008a ([[Cosmic stellar mass density growth]]) does.
...
- one side: [[Cosmic star formation history]]
- other side: [[Cosmic stellar mass density growth]]
- how the SFR is calibrated per galaxy: [[Galaxy main sequence of star formation]]

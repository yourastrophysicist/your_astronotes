...
the technique is extremely powerful for the Local Group (LMC/SMC, M31, dSphs) but cannot be applied to the bulk of the cosmic galaxy population. for that, see [[SED fitting for SFH]].

## connections

- complementary method: [[SED fitting for SFH]]
- enters population synthesis: [[Stellar population synthesis]]
- parametric priors for SED fits: [[Star formation history parametrizations]]

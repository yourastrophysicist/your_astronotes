...
see [[Case A vs Case B recombination]].
...
so high $\Gamma$ or low $n_e$ (high $U$) means more ionised; low $\Gamma$ or high $n_e$ means less ionised. see [[Photoionisation balance]] and [[Ionisation parameter U]].

...
---
are there black holes in [Globular clusters](Globular%20Clusters.html)? for decades the answer was assumed to be "no, or very few". the modern answer is "many, possibly hundreds per massive cluster", and the question has moved from existence to dynamics.

**the formation argument**

a [standard IMF](Salpeter%20Kroupa%20Chabrier%20IMFs.html) forms one stellar-mass BH per $\sim 500\,M_\odot$ of stars. for a typical massive GC of total stellar mass $\sim 10^6\,M_\odot$, that gives $\sim 2000$ BH progenitors. the ZAMS masses are $M \gtrsim 25\,M_\odot$; their MS lifetimes are $\sim 10\,\text{Myr}$, vanishingly short on cluster timescales. so all the BHs were made within the first few Myr of cluster formation, and any present today have been there for $\sim 12\,\text{Gyr}$.
...
3. **gravitational waves**: [LIGO-Virgo](BHs%20from%20gravitational%20waves.html) detections of BH-BH mergers with precessing spins, large mass ratios, and member masses in the pair-instability mass gap (e.g. GW190521 with $\sim 85\,M_\odot$ component) point to dynamical assembly in dense clusters as a viable channel.
...
- [IMBH](Intermediate-mass%20BHs%20in%20GCs.html) formation through repeated mergers in a BH subsystem becomes plausible (the "BH runaway" or "hierarchical merger" scenario).

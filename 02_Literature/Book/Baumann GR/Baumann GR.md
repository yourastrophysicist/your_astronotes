...
up: [[General_Relativity_MOC]] · 02_Literature
...
| --- | --- | --- | --- |
| 1 | [[Ch 1 - Gravity is Geometry]] | why do we need a new theory of gravity? | conceptual setup for Q9, Q10 |
| 2 | [[Ch 2 - Some Differential Geometry]] | how do i write down a curved spacetime? | Q1, Q2, Q3, Q4 |
| 3 | [[Ch 3 - A First Look at Geodesics]] | how does matter move in curved spacetime? | Q7, Q8, Q12, Q13, Q14 |
| 4 | [[Ch 4 - Spacetime Curvature]] | what does "curvature" mean precisely? | Q3, Q4, Q5, Q6, Q7, Q8, Q17 |
| 5 | [[Ch 5 - The Einstein Equation]] | how does matter source curvature? | Q11 (Schwarzschild derivation) |
| 6 | [[Ch 6 - Black Holes]] | what really happens at the horizon? | Q11 to Q14 oral follow-ups |
| 7 | [[Ch 7 - Cosmology]] | how does the universe evolve? | Q18, Q19, Q20 |
| 8 | [[Ch 8 - Gravitational Waves]] | does GR predict ripples in spacetime? | Q9, Q10, Q15, Q16, Q17 |
| 9 | [[Ch 9 - Inflation and Primordial Gravitational Waves]] | where did the FLRW universe come from, and is there a fossil signal? | beyond the exam, bridges Ch 7 + Ch 8 |
...
1. **[[Ch 3 - A First Look at Geodesics]]** the entire Schwarzschild story, including effective potential, ISCO, Mercury, Eddington. four exam questions live here.
2. **[[Ch 7 - Cosmology]]** the entire Friedmann derivation with all the cosmological consequences. three exam questions, including the cosmology block as a whole.
3. **[[Ch 8 - Gravitational Waves]]** linearized GR + Newtonian limit + TT gauge. five exam questions.
4. **[[Ch 4 - Spacetime Curvature]]** covariant derivative, Killing vectors, Riemann symmetries, geodesic deviation. seven exam questions.
5. **[[Ch 5 - The Einstein Equation]]** Einstein tensor, action, Schwarzschild derivation. one exam question + conceptual context.
6. **[[Ch 2 - Some Differential Geometry]]** manifolds, tensors, metric, local inertial frame. four exam questions.
7. **[[Ch 1 - Gravity is Geometry]]** equivalence principle, weak-field metric. conceptual but no direct exam questions.
8. **[[Ch 6 - Black Holes]]** great for oral follow-ups but not directly tested.
...
start with the simplest possible relativistic action, "minus mass times proper time elapsed." extremize. out pops the geodesic equation, with the [[Christoffel symbols]] formula in exactly the right place. no extra postulates, no sleight of hand. **the entire equation of motion is determined by demanding "the path that takes the most proper time."** that is breathtaking economy.

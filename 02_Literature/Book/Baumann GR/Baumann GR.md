...
i am using these chapter notes as a **reading companion**: a way to navigate Baumann while connecting to my exam prep. each note covers one chapter, with the same structure:
...
| ch | title | the question | exam Qs |
| --- | --- | --- | --- |
| 1 | [Ch 1 - Gravity is Geometry](./Ch%201%20-%20Gravity%20is%20Geometry.html) | why do we need a new theory of gravity? | conceptual setup for Q9, Q10 |
| 2 | [Ch 2 - Some Differential Geometry](./Ch%202%20-%20Some%20Differential%20Geometry.html) | how do i write down a curved spacetime? | Q1, Q2, Q3, Q4 |
| 3 | [Ch 3 - A First Look at Geodesics](./Ch%203%20-%20A%20First%20Look%20at%20Geodesics.html) | how does matter move in curved spacetime? | Q7, Q8, Q12, Q13, Q14 |
| 4 | [Ch 4 - Spacetime Curvature](./Ch%204%20-%20Spacetime%20Curvature.html) | what does "curvature" mean precisely? | Q3, Q4, Q5, Q6, Q7, Q8, Q17 |
| 5 | [Ch 5 - The Einstein Equation](./Ch%205%20-%20The%20Einstein%20Equation.html) | how does matter source curvature? | Q11 (Schwarzschild derivation) |
| 6 | [Ch 6 - Black Holes](./Ch%206%20-%20Black%20Holes.html) | what really happens at the horizon? | Q11 to Q14 oral follow-ups |
| 7 | [Ch 7 - Cosmology](./Ch%207%20-%20Cosmology.html) | how does the universe evolve? | Q18, Q19, Q20 |
| 8 | [Ch 8 - Gravitational Waves](./Ch%208%20-%20Gravitational%20Waves.html) | does GR predict ripples in spacetime? | Q9, Q10, Q15, Q16, Q17 |
| 9 | [Ch 9 - Inflation and Primordial Gravitational Waves](./Ch%209%20-%20Inflation%20and%20Primordial%20Gravitational%20Waves.html) | where did the FLRW universe come from, and is there a fossil signal? | beyond the exam, bridges Ch 7 + Ch 8 |

so all 20 official exam questions are covered by chapters 2 through 8. chapter 1 is the conceptual prologue. chapter 9 is an extension beyond Baumann's printed notes, into his cosmology/inflation work.
...
### mode 2, exam review (deep mode)

go straight to the chapter notes. each one ends with a "what to remember" paragraph that is the chapter compressed for oral exam. read those paragraphs in sequence, and they tell the whole GR story in about 8 paragraphs.
...
1. **[Ch 3 - A First Look at Geodesics](./Ch%203%20-%20A%20First%20Look%20at%20Geodesics.html)** the entire Schwarzschild story, including effective potential, ISCO, Mercury, Eddington. four exam questions live here.
2. **[Ch 7 - Cosmology](./Ch%207%20-%20Cosmology.html)** the entire Friedmann derivation with all the cosmological consequences. three exam questions, including the cosmology block as a whole.
3. **[Ch 8 - Gravitational Waves](./Ch%208%20-%20Gravitational%20Waves.html)** linearized GR + Newtonian limit + TT gauge. five exam questions.
4. **[Ch 4 - Spacetime Curvature](./Ch%204%20-%20Spacetime%20Curvature.html)** covariant derivative, Killing vectors, Riemann symmetries, geodesic deviation. seven exam questions.
5. **[Ch 5 - The Einstein Equation](./Ch%205%20-%20The%20Einstein%20Equation.html)** Einstein tensor, action, Schwarzschild derivation. one exam question + conceptual context.
6. **[Ch 2 - Some Differential Geometry](./Ch%202%20-%20Some%20Differential%20Geometry.html)** manifolds, tensors, metric, local inertial frame. four exam questions.
7. **[Ch 1 - Gravity is Geometry](./Ch%201%20-%20Gravity%20is%20Geometry.html)** equivalence principle, weak-field metric. conceptual but no direct exam questions.
8. **[Ch 6 - Black Holes](./Ch%206%20-%20Black%20Holes.html)** great for oral follow-ups but not directly tested.

---

## the moments where the book stops me

three places in Baumann where the physics is so clean it stops me. these are the moments i want to feel during the oral exam, the moments that tell me i actually understand it:
...
start with the simplest possible relativistic action, "minus mass times proper time elapsed." extremize. out pops the geodesic equation, with the [Christoffel symbols](../../../03_Zettel/Theory/Christoffel%20symbols.html) formula in exactly the right place. no extra postulates, no sleight of hand. **the entire equation of motion is determined by demanding "the path that takes the most proper time."** that is breathtaking economy.

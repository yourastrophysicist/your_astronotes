...
* **Website Repository**: [your_astronotes](https://github.com/yourastrophysicist/your_astronotes)
* **Published Garden**: [yourastrophysicist.github.io/your_astronotes](https://yourastrophysicist.github.io/your_astronotes/)
...
1. **[Fundamentals of Astrophysics and Cosmology](./04_Atlas/Fundamentals_Astrophysics_Cosmology_MOC.html)**
...
2. **[Observational Astrophysics](./04_Atlas/Observational_Astrophysics_MOC.html)**
...
3. **[General Relativity for Astrophysics](./04_Atlas/General_Relativity_MOC.html)**
...
4. **[Mathematical and Numerical Methods](./04_Atlas/Mathematical_Numerical_Methods_MOC.html)**
   Prof. M. Mapelli  
...
5. **[Astrophysics Laboratory 1 (High Energy)](./04_Atlas/Lab_High-Energy_MOC.html)**
   Prof. L. Burderi  
...
6. **[Astrophysics of Galaxies](./04_Atlas/Astrophysics_of_Galaxies_MOC.html)**
   Prof. A. Moretti  
...
7. **[Stellar Astrophysics](./04_Atlas/Stellar_Astrophysics_MOC.html)**
   Prof. A. Milone  
...
8. **[Astronomical Interferometry](./04_Atlas/Astronomical_Interferometry_MOC.html)**
   Prof. C. Pernechele  
...
9. **[Observational Cosmology](./04_Atlas/Observational_Cosmology_MOC.html)**
...
10. **[Astronomical Spectroscopy](./04_Atlas/Astronomical_Spectroscopy_MOC.html)**
    Prof. S. Ciroi  
...
11. **[Exoplanetary Astrophysics](./04_Atlas/Exoplanetary_Astrophysics_MOC.html)**
    Prof. G. Piotto  
...
12. **[Astro-Statistics and Cosmology](./04_Atlas/Astro-Statistics_and_Cosmology_MOC.html)**
    Prof. M. Liguori  
...
13. **[Astrophysics Laboratory 2](./04_Atlas/Astrophysics_Laboratory_2_MOC.html)**
...
14. **[Computational Astrophysics](./04_Atlas/Computational_Astrophysics_MOC.html)**
    Prof. T. Zingales  
...
15. **[Cosmology of the Early Universe](./04_Atlas/Cosmology_of_the_Early_Universe_MOC.html)**
...
16. **[Fluid and Plasma Dynamics](./04_Atlas/Fluid_and_Plasma_Dynamics_MOC.html)**
    Prof. M. Giacomin  
...
17. **[Astrophysics of the Interstellar Medium](./04_Atlas/Astrophysics_of_the_Interstellar_Medium_MOC.html)**
    Prof. G. Carraro  
...
* **04_Atlas/**: 17 comprehensive course Maps of Content and the central [04_Atlas Hub](./04_Atlas/04_Atlas.html). Start here for curricular syllabi and course roadmaps.
...
* **Theme**: Styled after the classic MediaWiki / Wikipedia Vector skin for clear, legible reading.
* **Mathematics**: All mathematical formulations are authored in standard LaTeX and rendered client-side using KaTeX.
* **Graph View**: An interactive force-directed canvas maps the cross-disciplinary connections between atomic notes.

---

## Contributing and Feedback

If you encounter a typographical error or algebraic inconsistency in any derivation, please open an issue directly on the [GitHub repository issues page](https://github.com/yourastrophysicist/your_astronotes/issues).
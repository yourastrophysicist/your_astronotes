...
- [Jeans theory and protostellar formation](../03_Zettel/Theory/Jeans%20theory%20and%20protostellar%20formation.html) — Giant Molecular Clouds (GMCs), hydrodynamic fluid equations (continuity, Euler, Poisson), sound speed $c_s$, sound crossing time $t_s$ vs free-fall time $t_{\text{ff}}$, perturbation analysis, master wave equation, Jeans dispersion relation $\omega^2 = k^2 c_s^2 - 4\pi G\rho_0$, Jeans wavevector $k_J$, Jeans length $\lambda_J = c_s\sqrt{\pi/G\rho_0}$, Jeans mass $M_J = \frac{\pi}{6}\rho_0 \lambda_J^3 \propto T^{3/2}\rho_0^{-1/2}$, energetic Virial derivation ($2K + \lvert U\rvert < 0$), isothermal hierarchical fragmentation into star clusters, ALMA protoplanetary disk observations, connection to Arbuzova et al. (2014) modified gravity (`stellar-35` to `63`).
...
- [Press-Schechter halo mass function](../03_Zettel/Theory/Press-Schechter%20halo%20mass%20function.html) — abundance of collapsed dark matter halos as a function of mass $dn/dM$, filtering Gaussian random density fields with top-hat window function, variance $\sigma^2(M)$, halo mass function formula $\frac{dn}{dM} = \sqrt{\frac{2}{\pi}} \frac{\bar\rho}{M} \frac{\delta_c}{\sigma^2} \left\lvert\frac{d\sigma}{dM}\right\rvert e^{-\frac{\delta_c^2}{2\sigma^2}}$.

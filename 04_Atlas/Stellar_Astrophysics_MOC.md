...
- **Gaia Collaboration / Vallenari et al. (2023)**, *A&A* 674, A1, [arXiv:2208.00211](https://arxiv.org/abs/2208.00211) — Gaia DR3: resolved cluster kinematics, proper-motion-cleaned CMDs, and white-dwarf cooling-track astrometry used across Blocks 5, 9, and 11. Full synthesis: [Gaia DR3 Summary](../02_Literature/Papers/11_Stellar_Astrophysics/Gaia_Collaboration_2023_DR3_Summary.html).
- **Paxton et al. (2011, 2019)** — MESA, *ApJS* 192, 3 / 243, 10, [arXiv:1009.1622](https://arxiv.org/abs/1009.1622) / [arXiv:1903.01426](https://arxiv.org/abs/1903.01426) — the open-source stellar evolution code underlying most modern isochrone grids alongside PARSEC. Full synthesis: [Paxton et al. — MESA](../02_Literature/Papers/11_Stellar_Astrophysics/Paxton_2011_2019_MESA_Stellar_Evolution_Code.html).
- **Hekker & Christensen-Dalsgaard (2017)**, *A&ARv* 25, 1, [arXiv:1609.07487](https://arxiv.org/abs/1609.07487) — giant-star asteroseismic scaling relations and mixed-mode period spacing. Full synthesis: [Hekker & Christensen-Dalsgaard — Giant Star Seismology](../02_Literature/Papers/11_Stellar_Astrophysics/Hekker_Christensen-Dalsgaard_2017_Giant_Star_Asteroseismology.html).

...
a galaxy's spectrum is not flat, so $N(m)$ depends *strongly* on the band you use. each wavelength is a different selection function on the galaxy population, and each has its own [K-correction](../../02_Zettel/Theory/K-correction.html), so the cosmological information you extract is different.
...
the Durham website gives postscript plots and tabulated text data for each band; pablo recommends pulling the K-band table for the LF normalization in the [Schechter K-band luminosity function](../../02_Zettel/Theory/Schechter K-band luminosity function.html) note.
...
see [K-correction in optical vs sub-mm](../../02_Zettel/Theory/K-correction in optical vs sub-mm.html) for the explicit form.
...
- previous: [Galaxy number counts N(m)](../../02_Zettel/Theory/Galaxy number counts N(m).md), [Differential vs cumulative number counts](../../02_Zettel/Theory/Differential vs cumulative number counts.html)
- band conversions: [K-correction in optical vs sub-mm](../../02_Zettel/Theory/K-correction in optical vs sub-mm.html)
- morphology split (in B-band): [Driver 1998 counts by morphology](../../02_Zettel/Theory/Driver 1998 counts by morphology.html)

...
- $\rho_{SFR} = \int (\text{SFR}/L)\, L\, \phi(L)\, dL$ is the [Cosmic star formation history](../../02_Zettel/Theory/Cosmic star formation history.html)
...
3. **sample**: split by morphology, color, environment, or sample-wide. each gives a different LF (see [LF by morphology and SED](../../02_Zettel/Theory/LF by morphology and SED.html)).
...
- the parametric form: [Schechter function](../../02_Zettel/Theory/Schechter function.html)
...
- integrals over $z$: [Cosmic star formation history](../../02_Zettel/Theory/Cosmic star formation history.html)

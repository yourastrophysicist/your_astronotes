...
<img src="{{ "/assets/images/Phase_referencing.svg" | relative_url }}" alt="Phase referencing: rapidly nodding telescopes between science target and a nearby point-like calibrator to correct atmospheric phase drift." class="note-img" loading="lazy" style="max-width: 100%; height: auto; border: 1px solid var(--border-subtle); border-radius: 2px; margin: 12px 0;" />

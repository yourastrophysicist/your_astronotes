...
<img src="{{ "/assets/images/The__u__v__plane.png" | relative_url }}" alt="The (u, v) plane spatial frequency distribution generated by interferometric baseline vectors on the sky." class="note-img" loading="lazy" style="max-width: 100%; height: auto; border: 1px solid var(--border-subtle); border-radius: 2px; margin: 12px 0;" />

...
**Related Zettels**: [Verifying random samples](../../02_Zettel/Theory/Verifying random samples.md), [Matplotlib plotting essentials](../../02_Zettel/Theory/Matplotlib plotting essentials.md)

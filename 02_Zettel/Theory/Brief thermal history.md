...
| **earliest visible galaxies** | meV | $z \sim 10$ | 700 Myr | reionization (see [Reionization](../../02_Zettel/Theory/Reionization.md)) |
...
| **nucleosynthesis** | $T \sim 0.1\text{–}1$ MeV | — | 3 minutes | light elements created (see [BBN_overview](../../02_Zettel/Theory/BBN_overview.md)) |
...
the matter-radiation equality scale is what determines the turnover of the matter power spectrum (see [Matter power spectrum and BAO](../../02_Zettel/Theory/Matter power spectrum and BAO.md)).
...
1. **CMB** ($z \sim 1100$, recombination/decoupling) — see [Cosmic_inventory_photons](../../02_Zettel/Theory/Cosmic_inventory_photons.md)
2. **BBN** ($T \sim 0.1\text{–}1$ MeV, three minutes) — see [BBN_overview](../../02_Zettel/Theory/BBN_overview.md)
3. **galaxy surveys** ($z \lesssim 10$) — see [Observational_Cosmology_MOC](../../00_Atlas/Observational_Cosmology_MOC.md)
...
- [Baumann_reference](../../02_Zettel/Theory/Baumann_reference.md) — chapter 3.1.3 walks through this same picture rigorously

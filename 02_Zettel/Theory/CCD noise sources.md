...
the sky background ([Sky brightness](../../02_Zettel/Theory/Sky brightness.html)) contributes photons to every pixel:
...
dividing the source signal by this gives the SNR formula (see [The CCD equation](../../02_Zettel/Theory/The CCD equation.html)).
...
- **CTE losses** (see [CCD readout chain](../../02_Zettel/Theory/CCD readout chain.html)).
...
the regime determines whether to take long single exposures or short stacked ones. see [The CCD equation](../../02_Zettel/Theory/The CCD equation.html) for the full discussion.
